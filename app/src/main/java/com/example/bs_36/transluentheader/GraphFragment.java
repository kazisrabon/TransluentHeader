...
public class GraphFragment extends Activity {
    ...
    private NotifyingScrollView.OnScrollChangedListener mOnScrollChangedListener = new NotifyingScrollView.OnScrollChangedListener() {
        public void onScrollChanged(ScrollView who, int l, int t, int oldl, int oldt) {
            final int headerHeight = findViewById(R.id.image_header2).getHeight() - getActionBar().getHeight();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((NotifyingScrollView) findViewById(R.id.scroll_view2)).setOnScrollChangedListener(mOnScrollChangedListener);
        ...
        result = new Drawer()
                ...
                .withOnDrawerListener(new Drawer.OnDrawerListener() {
                    ...
                    public void onDrawerOpened(View drawerView) {
                        Toast.makeText(GraphFragment.this, "onDrawerOpened", Toast.LENGTH_SHORT).show();
                        KeyboardUtil.hideKeyboard(GraphFragment.this);
                    }

                    @Override
                    public void onDrawerClosed(View drawerView) {
                        Toast.makeText(GraphFragment.this, "onDrawerClosed", Toast.LENGTH_SHORT).show();
                    }
                })
